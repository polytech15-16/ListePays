...
public class PaysHome {
	...
	public Pays findById(java.lang.String id) {
		log.debug("getting Pays instance with id: " + id);
		try {
			Pays instance = (Pays) sessionFactory.getCurrentSession().get("metier.Pays", id);
			if (instance == null) {
	...
	public List findByExample(Pays instance) {
		log.debug("finding Pays instance by example");
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("metier.Pays")
